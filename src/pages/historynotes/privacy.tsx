...
export default function Privacy() {
  return (
    <main>
      <Head>
        <title>Privacy Policy | History Notes</title>
        <meta
          name="description"
          content="Privacy policies of History Notes Android app"
          key="desc"
        />
      ...
      <div className="padding25 superPadding">
        ...
        <p>
          ...
          SERVICE is provided by Vignesh Marimuthu at no cost and is intended
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at History Notes - Take
          notes with Date unless otherwise defined in this Privacy Policy.
        </p>
        <h2>Information Collection and Use</h2>
        <p>
          For a better experience, while using our Service, I may require you to
          provide us with certain personally identifiable information, including
          but not limited to device status . The information that I request will
        ...
        <p>This policy is effective as of 2023-08-26</p>
        <h2>Contact Us</h2>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at vigneshmarimuthu2302@gmail.com
        </p>
      </div>
    </main>
  );
