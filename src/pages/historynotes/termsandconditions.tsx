...
export default function TermsAndCondition() {
  return (
    <main>
      <Head>
        <title>Terms and Conditions | History Notes</title>
        <meta
          name="description"
          content="Terms and Conditions of History Notes Android app"
          key="desc"
        />
      ...
      <div className="padding25px superPadding">
        ...
        <p>
          ...
          related to it, still belong to Vignesh Marimuthu.
        </p>
        <p>
          Vignesh Marimuthu is committed to ensuring that the app is as useful
        ...
        <p>
          The History Notes app stores and processes personal data that you have
          ...
          security features and it could mean that the History Notes app won&apos;t
        ...
        <p>
          You should be aware that there are certain things that Vignesh
          Marimuthu will not take responsibility for. Certain functions of the
          ...
          but Vignesh Marimuthu cannot take responsibility for the app not
        ...
        <p>
          Along the same lines, Vignesh Marimuthu cannot always take
          ...
          can&apos;t turn it on to avail the Service, Vignesh Marimuthu cannot accept
          responsibility.
        </p>
        <p>
          With respect to Vignesh Marimuthu&apos;s responsibility for your use of the
          ...
          that we can make it available to you. Vignesh Marimuthu accepts no
        ...
        <p>
          ...
          keep using the app. Vignesh Marimuthu does not promise that it will
